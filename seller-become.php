            ...
            <div class="col-lg-4 order-lg-2">
                <div class="poster-box">
                    <div class="poster-image">
                        <img src="assets/images/become-saller.svg" class="img-fluid" alt=""  loading="lazy">
                    </div>
                </div>
            </div>
...
<section class="business-section section-b-space">
    <div class="container-fluid-lg">
        <div class="vendor-title mb-5">
            <h5>Doing Business On G Digital India Is Really Easy</h5>
        </div>
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="vendor-title">
                    <h5>Start Selling</h5>
                    <p>G Digital India marketplace is India's leading platform for selling online. Be it a manufacturer,
                        vendor or supplier, simply sell your products online on G Digital India and become a top ecommerce
                        player with minimum investment. Through a team of experts offering exclusive seller
                        workshops, training, seller support and convenient seller portal, G Digital India focuses on
                        educating and empowering sellers across India. Selling on G Digital India.com is easy and

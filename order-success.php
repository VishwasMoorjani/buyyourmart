                                    ...
                                    <td class="product-detail">
                                        <div class="product border-0">
                                            ...
                                            <div class="product-detail">
                                                <ul>
                                                    <li class="name">
                                                        <a href="product-left-thumbnail.php">Brown Khadi Jacket X 1</a>
                                                    </li>
                                                    <li class="text-content">Sold By: Fresho</li>
                                                    <li class="text-content">Quantity - 1pcs</li>
                                                </ul>
                                            </div>
                                        </div>
                                    </td>
                                    ...
                                    <td class="product-detail">
                                        <div class="product border-0">
                                            ...
                                            <div class="product-detail">
                                                <ul>
                                                    <li class="name">
                                                        <a href="product-left-thumbnail.php">White top </a>
                                                    </li>
                                                    <li class="text-content">Sold By: Fresho</li>
                                                    <li class="text-content">Quantity - 1pcs</li>
                                                </ul>
                                    ...
                                    <td class="product-detail">
                                        <div class="product border-0">
                                            ...
                                            <div class="product-detail">
                                                <ul>
                                                    <li class="name">
                                                        <a href="product-left-thumbnail.php">Grey Jacket</a>
                                                    </li>
                                                    <li class="text-content">Sold By: Fresho</li>
                                                    <li class="text-content">Quantity - 1pcs</li>
                                                </ul>
                ...
                <div class="row g-4">
                    <div class="col-lg-12 col-sm-6">
                        <div class="summery-box">
                            ...
                            <ul class="summery-contain">
                                ...
                                <li>
                                    <h4> Shipping</h4>
                                    <h4 class="price theme-color">₹60</h4>
                                </li>

                                <li>
                                    <h4> GST</h4>
                                    <h4 class="price theme-color">₹216</h4>
                                </li>
                    ...
                    <div class="col-lg-12 col-sm-6">
                        <div class="summery-box">
                            ...
                            <ul class="summery-contain pb-2 border-bottom-0">
                                <li class="d-block">
